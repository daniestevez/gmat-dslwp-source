...
void ExtendedKalmanFilter::ComputeObs()
{
   ...
   {
      measCovariance = GetMeasurementCovariance();
   }
}
...
void ExtendedKalmanFilter::UpdateReportText()
{
   ...
   theTimeConverter->Convert("A1ModJulian", calculatedMeas->epoch,"","UTCGregorian", temp, times, 2);
   ...
   {
      Real timeTAI = theTimeConverter->Convert(
