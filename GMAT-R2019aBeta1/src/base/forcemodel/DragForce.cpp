   ...
   {                                                       // made changes by TUAN NGUYEN
      ...
      {                                                    // made changes by TUAN NGUYEN
         ...
         {                                                 // made changes by TUAN NGUYEN
            ...
            if (cdInitial[i] == -99999999.9999)            // made changes by TUAN NGUYEN
               cdInitial[i] = parm;                        // made changes by TUAN NGUYEN
         }                                                 // made changes by TUAN NGUYEN
         else                                              // made changes by TUAN NGUYEN
         {                                                 // made changes by TUAN NGUYEN
            dragCoeff.push_back(parm);                     // made changes by TUAN NGUYEN
            cdInitial.push_back(parm);                     // made changes by TUAN NGUYEN
         }                                                 // made changes by TUAN NGUYEN
...
void DragForce::ClearSatelliteParameters(const std::string parmName)
{
   ...
   if (parmName == "SPADDragScaleFactor")                  // made changes by TUAN NGUYEN
   {                                                       // made changes by TUAN NGUYEN
      dragCoeff.clear();                                   // made changes by TUAN NGUYEN
      cdInitial.clear();                                   // made changes by TUAN NGUYEN
   }                                                       // made changes by TUAN NGUYEN
