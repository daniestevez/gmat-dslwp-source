...
bool ODEModel::BuildModelFromMap()
{
   ...
   // Get SRP shape model from SolarRadiationPressure force            // made changes by TUAN NGUYEN
   std::string srpShapeModel = "Spherical";                            // made changes by TUAN NGUYEN
   for (Integer i = 0; i < forceList.size(); ++i)                      // made changes by TUAN NGUYEN
   {                                                                   // made changes by TUAN NGUYEN
      if (forceList[i]->IsOfType("SolarRadiationPressure"))            // made changes by TUAN NGUYEN
      {                                                                // made changes by TUAN NGUYEN
         srpShapeModel = ((SolarRadiationPressure*)forceList[i])->GetStringParameter("SRPModel");     // made changes by TUAN NGUYEN
         break;                                                        // made changes by TUAN NGUYEN
      }                                                                // made changes by TUAN NGUYEN
   }                                                                   // made changes by TUAN NGUYEN
   
   // Get DragForce shape model from DragForce                         // made changes by TUAN NGUYEN
   std::string dragShapeModel = "Spherical";                           // made changes by TUAN NGUYEN
   for (Integer i = 0; i < forceList.size(); ++i)                      // made changes by TUAN NGUYEN
   {                                                                   // made changes by TUAN NGUYEN
      if (forceList[i]->IsOfType("DragForce"))                         // made changes by TUAN NGUYEN
      {                                                                // made changes by TUAN NGUYEN
         dragShapeModel = ((DragForce*)forceList[i])->GetStringParameter("DragModel");     // made changes by TUAN NGUYEN
         break;                                                        // made changes by TUAN NGUYEN
      }                                                                // made changes by TUAN NGUYEN
   }                                                                   // made changes by TUAN NGUYEN
...
//               throw ODEModelException(
      ...
      // Set SRP and Drag shape models to spacecrafts                         // made changes by TUAN NGUYEN
      if (indexObj->IsOfType(Gmat::SPACECRAFT))                               // made changes by TUAN NGUYEN
      {                                                                       // made changes by TUAN NGUYEN
         ((Spacecraft*)indexObj)->SetSRPShapeModel(srpShapeModel);            // made changes by TUAN NGUYEN
         ((Spacecraft*)indexObj)->SetDragShapeModel(dragShapeModel);          // made changes by TUAN NGUYEN
      }                                                                       // made changes by TUAN NGUYEN
...
std::string ODEModel::GetShapeModel(std::string forcetype)
{
   ...
   if (forcetype == "SolarRadiationPressure")
   {
      for (Integer i = 0; i < forceList.size(); ++i)
      {
         ...
         {
            shapeModel = ((SolarRadiationPressure*)(forceList[i]))->GetStringParameter("SRPModel");
            break;
         }
      }
   }
   else if (forcetype == "DragForce")
   {
      for (Integer i = 0; i < forceList.size(); ++i)
      {
         ...
         {
            shapeModel = ((SolarRadiationPressure*)(forceList[i]))->GetStringParameter("DragModel");
            break;
         }
      }
   }
