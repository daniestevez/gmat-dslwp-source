      ...
      const Integer id)
{
   ...
   if (fillCartesian)
   {
      for (Integer i = 0; i < satCount; ++i) 
      {
         ...
         if (!inShadow) 
         {
            ...
            // else  // SPADFile                                 // made changes by TUAN NGUYEN
            ...
            {
               throw ODEModelException("Error: SolarRadiationPressure SRP Model was not specified. It needs to set to Spherical or SPADFile.\n");  // made changes by TUAN NGUYEN
            }
         }
         else 
         {
   ...
   if (fillSTM || fillAMatrix)
   {
      ...
      {
         if ((srpShapeModel == "Spherical") || (srpShapeModel == "SPADFile"))   // made changes by TUAN NGUYEN
         {
      ...
      for (Integer i = 0; i < stmCount; ++i)
      {
         ...
         if (!inShadow)
         {
            ...
            else if (srpShapeModel == "SPADFile")  // SPADFile  // made changes by TUAN NGUYEN
            {
               ...
               // VX term for estimating Cr                                                      // made changes by TUAN NGUYEN
               if (estimatingCr)                                                                 // made changes by TUAN NGUYEN
                  aTilde[ix + crEpsilonRow] = deriv[i6 + 3] * crInitial[i] / cr[i];              // made changes by TUAN NGUYEN
               ...
               // VY term for estimating Cr                                                      // made changes by TUAN NGUYEN
               if (estimatingCr)                                                                 // made changes by TUAN NGUYEN
                  aTilde[ix+crEpsilonRow] = deriv[i6 + 4] * crInitial[i] / cr[i];                // made changes by TUAN NGUYEN
               ...
               // VZ term for estimating Cr                                                      // made changes by TUAN NGUYEN
               if (estimatingCr)                                                                 // made changes by TUAN NGUYEN
                  aTilde[ix+crEpsilonRow] = deriv[i6 + 5] * crInitial[i] / cr[i];                // made changes by TUAN NGUYEN
...
Rvector6 SolarRadiationPressure::GetDerivativesForSpacecraft(Spacecraft *sc)
{
   ...
   if (srpShapeModel == "Spherical")                            // made changes by TUAN NGUYEN
      cr   = sc->GetRealParameter("Cr");                        // made changes by TUAN NGUYEN
   else if (srpShapeModel == "SPADFile")                        // made changes by TUAN NGUYEN
      cr = sc->GetRealParameter("SPADSRPScaleFactor");          // made changes by TUAN NGUYEN
   else                                                         // made changes by TUAN NGUYEN
      throw ODEModelException("Error: SRP model is not specified in SolarRadiationPressure object. The value should be Spherical or SPADFile.\n");  // made changes by TUAN NGUYEN
    ...
    {                                              // made changes by TUAN NGUYEN
       ...
       {                                           // made changes by TUAN NGUYEN
          ...
          {                                        // made changes by TUAN NGUYEN
             ...
             if (crInitial[i] == -99999999.9999)   // made changes by TUAN NGUYEN
                crInitial[i] = parm;               // made changes by TUAN NGUYEN
          }                                        // made changes by TUAN NGUYEN
          else                                     // made changes by TUAN NGUYEN
          {                                        // made changes by TUAN NGUYEN
             cr.push_back(parm);                   // made changes by TUAN NGUYEN
             crInitial.push_back(parm);            // made changes by TUAN NGUYEN
          }                                        // made changes by TUAN NGUYEN
                                                   ...
                                                   const std::string parmName)
{
   ...
   if ((parmName == "SPADSRPScaleFactor"))                 // made changes by TUAN NGUYEN
   {                                                       // made changes by TUAN NGUYEN
      cr.clear();                                          // made changes by TUAN NGUYEN
      crInitial.clear();                                   // made changes by TUAN NGUYEN
   }                                                       // made changes by TUAN NGUYEN
