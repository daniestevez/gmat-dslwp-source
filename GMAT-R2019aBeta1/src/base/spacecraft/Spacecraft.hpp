...
//      ORBIT_COVARIANCE,
   ...
   std::string       srpShapeModel;             // It would be "Spherical" or "SPADFile"   // made changes by TUAN NGUYEN
...
//   Rmatrix           orbitAMatrix;
   ...
   /// the scale factor to use for the SPAD SRP data
   ...
   /// the scale factor to use for the SSPAD Drag data
